  ...
  const options = [
    {
      ...
      message:
        'Copy and paste your data from other applications or websites. You can use tabular TSV, CSV or JSON data.',
      icon: BsClipboard,
    ...
    },
    {
      ...
      message: 'You can load tabular TSV, CSV or JSON data.',
      icon: BsUpload,
      allowedForReplace: true,
    },
    // {
